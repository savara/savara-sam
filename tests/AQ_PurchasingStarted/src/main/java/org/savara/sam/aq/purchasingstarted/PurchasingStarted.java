 ...
 * MA  02110-1301, USA.
 */
package org.savara.sam.aq.purchasingstarted;
...
public class PurchasingStarted extends JEEActiveQueryManager<String,String> implements MessageListener {
	...
	public static class PurchasingStartedPredicate implements Predicate<String>, java.io.Serializable {
		
		private static final long serialVersionUID = 5086630412993298230L;

		private static ActiveQuerySpec _aqSpec=null;
		
		public PurchasingStartedPredicate() {
		}
		...
		public boolean evaluate(String value) {
			...
			if (si != null &&
					...
					si.getDirection() == ServiceInvocation.Direction.INBOUND) {
				return (true);
			}
