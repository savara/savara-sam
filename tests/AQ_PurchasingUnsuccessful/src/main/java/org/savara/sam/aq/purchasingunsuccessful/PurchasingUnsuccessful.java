               ...
               activationConfig =
                     {
                        ...
                        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/activity/PurchasingUnsuccessful")
                     })
...
public class PurchasingUnsuccessful implements MessageListener {
	...
	@Resource(mappedName = "java:/topics/activity/PurchasingUnsuccessful")
	...
	public void init() {
		...
		if (_activeQuery == null) {
			_activeQuery = new DefaultActiveQuery<ActivitySummary>(ACTIVE_QUERY_NAME, new PurchasingUnsuccessfulPredicate());
