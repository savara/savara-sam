...
public class PurchasingUnsuccessful extends JEEActiveQueryManager<String,String> implements MessageListener {
	...
	public static class PurchasingUnsuccessfulPredicate implements Predicate<String>, java.io.Serializable {
